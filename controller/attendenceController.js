...
exports.changeUserStatus = async (req, res) => {
  try {
    const schema = Joi.object({
      ...
      status: Joi.string().valid('PRESENT', 'ABSENT', 'HALFDAY', 'ONLEAVE', 'WOP', 'HOP', 'WEEKLYOFF', 'LOP', 'SL', 'CL', 'HO', 'CO', 'SP', 'WFH').label('Status'),
      clockIn: Joi.string().allow('').label('Clock In'),
      clockOut: Joi.string().allow('').label('Clock Out'),
      shiftStart: Joi.string().allow('').label('Shift Start'),
      shiftEnd: Joi.string().allow('').label('Shift End'),
